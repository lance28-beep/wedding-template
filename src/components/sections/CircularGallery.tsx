...
class Media {
  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      uniforms: {
        tMap: { value: texture },
        uPlaneSizes: { value: [1, 1] },  // Default values to prevent undefined
        uImageSizes: { value: [1, 1] },  // Default values to prevent undefined
        uSpeed: { value: 0 },
        uTime: { value: 0 },
    ...
    if (this.image.startsWith('/')) {
      loadImage(this.image)
        ...
        .catch(err => {
          ...
          // Load a placeholder or default image here if needed
        });
    } else {
      loadImage(this.image)
        .then(img => {
    ...
    const defaultItems = [
      {
        ...
        text: "First Look",
        description: "The magical moment when we first saw each other"
      },
      {
        image: `/img/Photogallery/image_2.png`,
        text: "Vows Exchange",
        description: "Promising forever in front of our loved ones"
      },
      {
      ...
      },
      {
        ...
        description: "Celebrating with our families"
      },
      {
        image: `/img/Photogallery/image_5.png`,
        text: "Cake Cutting",
        description: "Sweet moments of our wedding cake"
      },
      {
        image: `/img/Photogallery/image_6.png`,
        text: "Bouquet Toss",
        description: "Sharing the joy with friends"
      },
      {
      ...
      },
      {
        ...
        text: "Wedding Party",
        description: "Our amazing bridal party"
      },
      {
        image: `/img/Photogallery/image_9.png`,
        text: "Ceremony Details",
        description: "Beautiful moments from our ceremony"
      },
      {
      ...
      },
      {
        ...
        text: "Wedding Portraits",
        description: "Timeless memories captured"
      }
    ];
...
export default function CircularGallery({
  ...
  }, [items, bend, textColor, borderRadius, font, theme]);

  return (
    <div
      className="w-full h-full overflow-hidden cursor-grab active:cursor-grabbing rounded-2xl transition-all duration-300 hover:shadow-2xl dark:hover:shadow-romantic/10"
      ref={containerRef}
      style={{
        perspective: '1000px',
